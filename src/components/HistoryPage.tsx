    ...
    <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 space-y-6 animate-fadeIn">
      ...
      <div className="flex items-center justify-between">
        <button
          type="button"
          onClick={onBack}
          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-300 hover:text-white text-sm font-semibold transition border border-slate-700/60 cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-slate-800/80 border border-slate-700/60 rounded-xl p-4 flex flex-col items-center sm:items-start">
          <div className="flex items-center gap-1.5 text-xs text-indigo-400 font-bold uppercase tracking-wider mb-1">
        ...
        <div className="bg-slate-800/80 border border-slate-700/60 rounded-xl p-4 flex flex-col items-center sm:items-start">
          ...
          <span className="text-xs text-slate-500 mt-0.5">all-time best</span>
        </div>
        ...
        <div className="bg-slate-800/80 border border-slate-700/60 rounded-xl p-4 flex flex-col items-center sm:items-start">
          ...
          <span className="text-xs text-slate-500 mt-0.5">points/sprint</span>
        </div>
        ...
        <div className="bg-slate-800/80 border border-slate-700/60 rounded-xl p-4 flex flex-col items-center sm:items-start">
          ...
          <span className="text-xs text-slate-500 mt-0.5">correct answers</span>
        </div>
      </div>
